  ...
  var PKREC = function (app) {
    ...
    this.start = function (
      ...
      if (!navigator.mediaDevices) {
        ...
        app.fireEvent("ShowError", t("No recording device found"));
        return false;
      }
      ...
      if (!_sample_rate) {
        ...
        else sample_rate = audio_context.sampleRate;
      }
    ...
    this.stop = function (cancel_recording) {
      ...
      if (temp_buffers.length > 0 && !cancel_recording)
        end_record_func &&
          end_record_func(starting_offset / sample_rate, temp_buffers);
      else end_record_func && end_record_func(null, null);
