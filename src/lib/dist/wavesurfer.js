...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  if (root) root["WaveSurfer"] = factory();
})(window, function () {
          ...
          var MultiCanvas = (function (_Drawer) {
            ...
            function MultiCanvas(container, params) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  MultiCanvas.__proto__ || Object.getPrototypeOf(MultiCanvas)
                ).call(this, container, params)
              );
            ...
            _createClass(MultiCanvas, [
                ...
                value: function updateSize() {
                  ...
                  this.canvases.forEach(function (entry, i) {
                    ...
                    var canvasWidth =
                      ...
                      2 * Math.ceil(_this2.params.pixelRatio / 2);

                    if (i == _this2.canvases.length - 1) {
                      canvasWidth =
                        _this2.width -
                        _this2.maxCanvasWidth * (_this2.canvases.length - 1);
                    }
              ...
              },
              {
                ...
                value: function updateDimensions(entry, width, height) {
                  ...
                  entry.start =
                    entry.waveCtx.canvas.offsetLeft / totalWidth || 0;
                ...
                value: function drawWave(
                  ...
                  return this.prepareDraw(
                    ...
                    function (_ref2) {
                      ...
                      if (start !== undefined) {
                        _this5.drawLine(
                          _this5.params.limits,
                          _this5.params.timeline,
                          peaks,
                          absmax,
                          halfH,
                          offsetY,
              ...
              },
              {
                ...
                value: function drawLineToContext(
                  ...
                  if (lim) {
                    ...
                    if (val > offsetY) ctx.fillRect(0, val, this.width, 0.5);
              ...
              },
              {
                ...
                value: function prepareDraw(
                  ...
                  return (function () {
                    ...
                    var height =
                      (_this7.params.height / 2) * _this7.params.pixelRatio;
                    var offsetY = height * channelIndex || 0;

                    var halfH = height / 2;
                    if (totalChannels === 1) halfH = height;
              ...
              },
              {
                ...
                value: function updateProgress(position) {
                  ...
                  this.progressWave.style.transform =
  ...
  \*****************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _webaudio = __webpack_require__(
          ...
          var MediaElement = (function (_WebAudio) {
            ...
            function MediaElement(params) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  MediaElement.__proto__ || Object.getPrototypeOf(MediaElement)
                ).call(this, params)
              );
            ...
            _createClass(MediaElement, [
              ...
              },
              {
                ...
                value: function getPeaks(length, first, last) {
                  if (this.buffer) {
                    return _get(
                      MediaElement.prototype.__proto__ ||
                        Object.getPrototypeOf(MediaElement.prototype),
                      "getPeaks",
                      this
  ...
  \**************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _observer = __webpack_require__(
  ...
  \***************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _getId = __webpack_require__(
          ...
          var _preventClick = __webpack_require__(
  ...
  \***************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _mediaelement = __webpack_require__(
            /*! ./mediaelement */ "./src/mediaelement.js"
          );

          var _mediaelement2 = _interopRequireDefault(_mediaelement);

          var _peakcache = __webpack_require__(
          ...
          var WaveSurfer = (function (_util$Observer) {
            ...
            function WaveSurfer(params) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (
                  WaveSurfer.__proto__ || Object.getPrototypeOf(WaveSurfer)
                ).call(this)
              );
            ...
            _createClass(WaveSurfer, [
              ...
              },
              {
                ...
                value: function createDrawer() {
                  ...
                  this.drawer.on("resize", function () {
                    ...
                    _this5.drawer._width = Math.round(
                      _this5.drawer.container.clientWidth *
                        _this5.drawer.params.pixelRatio
                    );
                    //console.log (_this5.drawer._width);
                  });
                  ...
                  this.drawer.on("redraw", function () {
                    ...
                    _this5.drawer.progress(
                      ...
                      _this5.LeftProgress / _this5.getDuration(),
                      _this5.ZoomFactor
                    );
                  });
                  ...
                  if ("ontouchstart" in document.documentElement) {
                    ...
                    this.drawer.on("touchend", function (e) {
                      if (touch_pos.x !== 0 && touch_pos.y !== 0) {
                        if (
                          (last_touch_pos.x === 0 && last_touch_pos.y === 0) ||
                          (Math.abs(last_touch_pos.x - touch_pos.x) < 20 &&
                            Math.abs(last_touch_pos.y - touch_pos.y) < 20)
                        ) {
                          setTimeout(function () {
                            ...
                            if (
                              !_this5.drawer.params.fillParent &&
                            ...
                            var new_progress =
                              (progress * _this5.VisibleDuration +
                                _this5.LeftProgress) /
                              _this5.getDuration();
                  ...
                  this.SetZoom = function (where, step, event, is_redo) {
                    ...
                    if (step < 0) {
                      ...
                      if (_this5.ZoomFactor === 1) _this5.LeftProgress = 0;
                      else
                        _this5.LeftProgress =
                          _this5.LeftProgress -
                          where * (duration / _this5.ZoomFactor);
              ...
              },
              {
                ...
                value: function ZoomifyValue(progress) {
                  return (
                    (progress * this.VisibleDuration + this.LeftProgress) /
                    this.getDuration()
                  );
                },
              },
              ...
              },
              {
                ...
                value: function UnzoomifyPixelValue(progress) {
                  return (
                    (progress -
                      (this.LeftProgress / this.getDuration()) *
                        this.drawer.width) *
                    this.ZoomFactor
                  );
                },
              },
              {
                ...
                value: function DrawTemp(_offset, _arrays) {
                  ...
                  this.drawer.CursorMarker.style.transform =
                    "translate(" + pos + "px,0)";
              ...
              },
              {
                ...
                value: function createBackend() {
                  ...
                  this.CursorCenter = function () {
                    ...
                    var left_middle =
                      ((q.LeftProgress / durr) * maxScroll + half) >> 0;

                    if (
                      left_middle + half > real &&
                      left_middle + half < maxScroll
                    ) {
                      var cursor =
                        ((percentage - q.LeftProgress / durr) *
                          q.ZoomFactor *
                          100) >>
                        0;
                      if (cursor > 50) {
                        ...
                        target = Math.max(
                          0,
                          Math.min(maxScroll - half * 2, target)
                        );
                    } else
                      target = Math.max(
                        0,
                ...
                value: function seekTo(progress, stamp) {
                  ...
                  if (
                    this.VisibleDuration / duration +
                      this.LeftProgress / duration >
                      progress &&
                    progress > this.LeftProgress / duration
                  ) {
                    ...
                    if (rend_progress == 0) {
                      ...
                      var minPxDelta = 1 / this.drawer.params.pixelRatio;
                      var pos =
                        Math.round(ppp * this.drawer.width) * minPxDelta;
                      this.drawer.CursorMarker.style.transform =
                        "translate(" + pos + "px,0)";
              ...
              },
              {
                ...
                value: function drawBuffer(force) {
                  ...
                  if (this.ZoomFactor === 1)
                    this.VisibleDuration = this.getDuration();
                  else
                    this.VisibleDuration = this.getDuration() / this.ZoomFactor;
                  ...
                  if (this.backend.extraPeakStart >= 0) {
                    ...
                    var q = this;
                    requestAnimationFrame(function () {
                      q.drawer.canvases[0].waveCtx.fillStyle =
                        "rgba(255,60,40,0.2)";
                      q.drawer.canvases[0].waveCtx.fillRect(
                        q.backend.extraPeakStart,
                        0,
                        q.backend.extraPeakEnd - q.backend.extraPeakStart,
                        q.drawer.canvases[0].wave.height
                      );
                    });
                  }
                  ...
                  this.backend.decodeArrayBuffer(
                    ...
                    function (data) {
                      ...
                      if (!_this13.isDestroyed) {
                        ...
                        if (_this13.bid[_id]) {
                          ...
                          if (go) {
                            // add the main area // todo - put it somewhere else?
                            setTimeout(function () {
                              _this13.regions.add({
                                start: old_duration,
                    ...
                    function () {
                      return _this13.fireEvent(
                        "error",
                        "Error decoding audiobuffer. Did you make sure to supply a valid audio file? "
                      );
                    }
                  );
                },
                ...
                value: function getArrayBuffer(url, callback) {
                  ...
                  this.tmpEvents.push(
                    ...
                    ajax.on("error", function (e) {
                      _this14.fireEvent(
                        "error",
                        "Could not load remote URL. Make sure the url exists, is a valid audio file,<br /> " +
                          " or that is supports Cross Origin requests (Access-Control-Allow-Origin header) <br />" +
                          e.target.statusText
                      );
                      _this14.currentAjax = null;
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var WebAudio = (function (_util$Observer) {
            ...
            function WebAudio(params) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (WebAudio.__proto__ || Object.getPrototypeOf(WebAudio)).call(
                  this
                )
              );
            ...
            _createClass(WebAudio, [
              ...
              },
              {
                ...
                value: function addOnAudioProcess() {
                  ...
                  this.scriptNode.onaudioprocess = function (ee) {
                    ...
                    if (!_this2.states[PLAYING]) return;
              ...
              },
              {
                ...
                value: function removeOnAudioProcess() {
                  ...
                  if (!is_safari) this.scriptNode.onaudioprocess = null;
              ...
              },
              {
                ...
                value: function decodeArrayBuffer(
                  ...
                  var promise = this.offlineAc.decodeAudioData(
                    arraybuffer,
                    function (data) {
                      // ----
              ...
              },
              {
                ...
                value: function setLength(length) {
                  ...
                  if (
                    this.mergedPeaks &&
                    length * 2 == this.mergedPeaks.length
                  ) {
                    return;
                  }
                ...
                value: function getPeaks(length, first, last, force) {
                      ...
                      for (j = start; j < end; j += sampleStep) {
                        ...
                        if (this.reg) {
                          if (
                            ...
                            j >= this.reg.initpos.start &&
                            j <= this.reg.initpos.end
                          ) {
                            value = 0;
                          }
                          // ----
                  ...
                  if (this.extraPeaks) {
                    ...
                    if (first <= this.extraOffset && last > extraoffset) {
                      extraoffset =
                        ((this.extraOffset - first) / sampleSize) >> 0;
                      ...
                      var templength =
                        (extraoffset +
                          (extra_arr_len * extra_len) / sampleSize) >>
                        0;
                      ...
                      for (c = 0; c < channels; ++c) {
                        ...
                        for (i = extraoffset; i <= templength; ++i) {
                          ...
                          for (j = start; j < end; j += sampleStep) {
                            ...
                            var value = this.extraPeaks[val >> 0][
                              j % extra_arr_len
                            ];
              ...
              },
              {
                ...
                value: function load(buffer) {
                  if (!this.buffer || !this._add) {
                    ...
                    var newLen =
                      (originalDuration + newDuration) * this.buffer.sampleRate;
                    ...
                    var offset =
                      ((originalDuration / 1) * originalBuffer.sampleRate) >> 0;
                    ...
                    for (var i = 0; i < originalBuffer.numberOfChannels; ++i) {
                      ...
                      if (offset < originalBuffer.length + buffer.length) {
                        uberChanData.set(
                          chan_data.slice(offset),
                          offset + segment_chan_data.length
                        );
                      }
                ...
                value: function play(start, end) {
                  ...
                  if (!this.states[PLAYING]) {
                    _defineProperty(
                      this.states,
                      PLAYING,
                      Object.create(this.stateBehaviors[PLAYING])
                    );
                  }
