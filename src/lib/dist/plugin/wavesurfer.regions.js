...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["regions"] = factory();
  else
  ...
  return /******/ (function (modules) {
    ...
    /******/ /******/ return __webpack_require__(
      (__webpack_require__.s = "./src/plugin/regions.js")
    );
    /******/
  })(
    /************************************************************************/
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var Region = (function () {
            function Region(params, ws) {
              ...
              this.drag =
                params.drag === undefined ? true : Boolean(params.drag);
            ...
            _createClass(Region, [
              ...
              },
              {
                ...
                value: function render() {
                  ...
                  /* Resize handles */
                  if (this.resize) {
                    var handleLeft = regionEl.appendChild(
                      document.createElement("handle")
                    );
                    var handleRight = regionEl.appendChild(
                      document.createElement("handle")
                    );
                    handleLeft.className =
                      "wavesurfer-handle wavesurfer-handle-start";
                    handleRight.className =
                ...
                value: function bindInOut() {
                  ...
                  var onProcess = function onProcess(time) {
                    ...
                    if (
                      !_this3.firedOut &&
                      _this3.firedIn &&
                      (_this3.start >= time || _this3.end <= time)
                    ) {
                  ...
                  this.on("out", function () {
                    ...
                    if (_this3.loop) {
                      ...
                      // ####
                      _this3.wavesurfer.seekTo(
                        _this3.start / _this3.wavesurfer.getDuration()
                      );
                ...
                value: function bindEvents() {
                  ...
                  (this.drag || this.resize) &&
                    ...
                    */
                        ...
                        var scrollLeft =
                          (scroll_speed * scrollDirection) /
                          _this4.wavesurfer.getDuration();
                        _this4.wavesurfer.LeftProgress += scrollLeft;
                        if (_this4.wavesurfer.LeftProgress < 0)
                          _this4.wavesurfer.LeftProgress = 0;
                        else if (
                          _this4.wavesurfer.LeftProgress +
                            _this4.wavesurfer.VisibleDuration >
                          _this4.wavesurfer.getDuration()
                        ) {
                          _this4.wavesurfer.LeftProgress =
                            _this4.wavesurfer.getDuration() -
                        ...
                        // Update time
                        var time =
                          _this4.wavesurfer.ZoomifyValue(
                            _this4.wavesurfer.drawer.handleEvent(e)
                          ) * duration;
                      ...
                      var onDown = function onDown(e) {
                        ...
                        startTime =
                          _this4.wavesurfer.ZoomifyValue(
                            _this4.wavesurfer.drawer.handleEvent(e, true)
                          ) * duration;

                        // Store for scroll calculations
                        maxScroll =
                          _this4.wrapper.scrollWidth -
                          _this4.wrapper.clientWidth;
                        ...
                        if (e.target.tagName.toLowerCase() == "handle") {
                          if (
                            ...
                            e.target.classList.contains("wavesurfer-handle-end")
                          ) {
                            resize = "end";
                          }
                      ...
                      _this4.on("remove", function () {
                        ...
                        _this4.wrapper.removeEventListener(
                          "pointermove",
                          onMove
                        );
                      });
                ...
                value: function create(params) {
                  return {
                    ...
                    staticProps: {
                      ...
                      enableDragSelection: function enableDragSelection(
                        options
                      ) {
                        if (!this.initialisedPluginList.regions) {
                          this.initPlugin("regions");
            ...
            _createClass(RegionsPlugin, [
              ...
              },
              {
                ...
                value: function add(params) {
                  ...
                  var region = new this.wavesurfer.Region(
                    params,
                    this.wavesurfer
                  );
              ...
              },
              {
                ...
                value: function enableDragSelection(params) {
                  ...
                  var scroll =
                    params.scroll !== false &&
                    this.wavesurfer.params.scrollParent;
                ...
                */
                    ...
                    var scrollLeft =
                      (scroll_speed * scrollDirection) /
                      _this8.wavesurfer.getDuration();
                    _this8.wavesurfer.LeftProgress += scrollLeft;

                    if (_this8.wavesurfer.LeftProgress < 0)
                      _this8.wavesurfer.LeftProgress = 0;
                    else if (
                      _this8.wavesurfer.LeftProgress +
                        _this8.wavesurfer.VisibleDuration >
                      _this8.wavesurfer.getDuration()
                    ) {
                      _this8.wavesurfer.LeftProgress =
                        _this8.wavesurfer.getDuration() -
                    ...
                    // Update range
                    var end = _this8.wavesurfer.ZoomifyValue(
                      _this8.wavesurfer.drawer.handleEvent(e)
                    );
                    region.update({
                  ...
                  var eventDown = function eventDown(e) {
                    ...
                    // Store for scroll calculations
                    maxScroll =
                      _this8.wrapper.scrollWidth - _this8.wrapper.clientWidth;
                    wrapperRect = _this8.wrapper.getBoundingClientRect();

                    drag = true;
                    start = _this8.wavesurfer.ZoomifyValue(
                      _this8.wavesurfer.drawer.handleEvent(e, true)
                    );
                  ...
                  this.on("disable-drag-selection", function () {
                    ...
                    _this8.wrapper.removeEventListener(
                      "pointerdown",
                      eventDown
                    );
                  });
                  ...
                  var eventUp = function eventUp(e) {
                    ...
                    if (e.which === 3) {
                      ...
                      if (right_mouse) {
                        if (
                          Math.abs(right_mouse.x - e.pageX) < 3 &&
                          Math.abs(right_mouse.y - e.pageY) < 7
                        ) {
                  ...
                  var eventMove = function eventMove(e) {
                    ...
                    if (_this8.wavesurfer.ZoomFactor > 1) {
                      ...
                      if (x <= scrollThreshold) {
                        ...
                        x >=
                        wrapperRect.right - wrapperRect.left - scrollThreshold
                      ) {
                        scrollDirection = 1;
                      } else {
                        scrollDirection = null;
