...
(function (w, d, PKAE) {
            ...
            action: function () {
              new PKSimpleModal({
                        ...
                        if (radios[l].checked) {
                          if (radios[l].name == "frmtex") {
                            ...
                            if (radios[l].value === "sel") {
                              var region =
                                app.engine.wavesurfer.regions.list[0];
                ...
                setup: function (q) {
                  ...
                  if (chan_num === 2) {
                    q.el_body.getElementsByClassName(
                      "pk_stereo"
                    )[0].checked = true;
                  }
                          ...
                          for (var i = 0; i < inputs.length; ++i) {
                            if (inputs[i].checked) {
                              if (inputs[i].value === "mp3") {
                                ...
                                inputtxt.value = inputtxt.value.replace(
                                  ".wav",
                                  ".mp3"
                                );
                              } else {
              ...
              new PKSimpleModal({
                ...
                setup: function (q) {
                  ...
                  if (!region) {
                    ...
                    lblr.childNodes[1].innerText =
                      app.ui.formatTime(region.start) +
                      " to " +
                      app.ui.formatTime(region.end);
                  }
              ...
              app.listenFor("LoadDraft", function (name, append) {
                app.fls.Init(function (err) {
                  ...
                  if (append === 3) {
                    ...
                    var aud_cont = new (w.AudioContext ||
  ...
  function _makeUITopHeader(menu_tree, UI) {
    ...
    this.openMenu = function (index, is_mouse) {
      ...
      if (max - left < 200) {
        ...
        if (offset > 1)
          parent.getElementsByClassName("pk_menu")[0].style.left =
            -offset / 2 + "px";
      }
      ...
      UI.KeyHandler.addCallback(
        ...
        function (key, m, e) {
          if (!target_option) {
            ...
            target_option = target_el.parentNode.getElementsByClassName(
              "pk_opt"
            );
            if (ind - 1 < 0) {
    ...
    var mousemove = function (e) {
      ...
      if (
        target_el ||
        (UI.InteractionHandler.on && UI.InteractionHandler.by === _name)
      ) {
  ...
  function _makeUIMainView(UI, app) {
    ...
    btn_zoom_reset.innerHTML = "[R] <span>Resetar Zoom (0)</span>";
    ...
    UI.listenFor("DidZoom", function (v) {
      ...
      if (e === 1) {
        ...
        if (!wavepoint_visible) {
          ...
          var perc =
            app.engine.wavesurfer.getCurrentTime() /
            app.engine.wavesurfer.getDuration();
    ...
    var waveScrollMouseMove = function (e) {
      ...
      waveScrollMouseUp = function (e) {
        ...
        document.removeEventListener("touchmove", waveScrollMouseMove, {
          passive: false,
        });
    ...
    var mdown = function (e) {
      ...
      if (e.is_touch) {
        document.addEventListener("touchmove", waveScrollMouseMove, {
          passive: false,
        });
  ...
  function _makeUIToolbar(UI) {
    ...
    btn_back_jump.innerHTML = "<span>Retroceder (seta esquerda)</span>";
    ...
    btn_back_jump.onfocus = function () {
      ...
      var step = function (num, count) {
        if (document.activeElement === btn) {
          ...
          var middle_step =
            PKAudioEditor.engine.wavesurfer.getDuration() / block;
          var zoom = PKAudioEditor.engine.wavesurfer.ZoomFactor;
          middle_step /= zoom;
    ...
    UI.listenFor("DidAudioProcess", function (val) {
      ...
      if (!loudness) {
        ...
        UI.footer.volumeGaugeInner.style.transform =
          "translate3d(" + volume1 + "%,0,0)";
        UI.footer.volumeGaugeInner2.style.transform =
          "translate3d(" + volume2 + "%,0,0)";
    ...
    btn_clear_selection.innerHTML = "<span>Limpar Seleção (~ tilda)</span>";
    ...
    UI.listenFor("DidCreateRegion", function (region) {
      ...
      if (region) {
        if (!sel_spans[0])
          sel_spans = document.querySelectorAll(".pk_sellist .pk_dat");
      ...
      function (e) {
        ...
        if (xx[0]) {
          ...
          if (xx.scrollHeight > window.innerHeight) {
            ...
            if (direction > 0) {
              var modal_h = document.getElementsByClassName("pk_modal")[0]
                .clientHeight;
