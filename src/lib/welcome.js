  ...
  setTimeout(function () {
    PKAudioEditor._deps.Wlc = function () {
      ...
      if (PKAE.isMobile) {
        ...
        body_str2 =
          'Check out the codebase on <a href="https://github.com/pkalogiros/audiomass" target="_blank">Github</a><br/><br/>'; // checkout the code on github
      }

      // Welcome to AudioMass,
      var md = new PKSimpleModal({
        title:
          '<font style="font-size:15px">Welcome to Editor de Audio (Ramos Sound)</font>',
        ...
        body:
          ...
          "Rodrigo Ramos Sound is a free, open source, web-based Audio and Waveform Editor.<br />It runs entirely in the browser with no backend and no plugins required!" +
          "<br/><br/><br/>" +
          body_str +
        ...
        setup: function (q) {
          ...
          PKAE.ui.KeyHandler.addCallback(
            "modalTemp",
            function (e) {
              q.Destroy();
            },
